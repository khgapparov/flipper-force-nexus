  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white shadow-glow border-0 hover:shadow-elegant hover:scale-105 transition-bounce font-semibold",
        success: "bg-gradient-success text-success-foreground shadow-elegant hover:shadow-glow hover:scale-105 transition-bounce",
        construction: "bg-gradient-secondary text-secondary-foreground shadow-elegant hover:shadow-glow hover:scale-105 transition-bounce font-semibold"
      },
      size: {
